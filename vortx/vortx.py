...
from vortx import cnn2d, cnn3d, mv_fusion, utils, view_direction_encoder


class Vortx(torch.nn.Module):
    ...
    def forward(self, batch, voxel_inds_16):
        ...
        for resname, res in self.resolutions.items():
            ...
            try:
                ...
                # https://github.com/mit-han-lab/torchsparse/issues/16
                # torchsparse convolution raises an Exception if the input contains
                # 0 voxels
                print(e)
